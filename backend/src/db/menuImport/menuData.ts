/* eslint-disable */
// RETAINED IMPORT SNAPSHOT — NOT RUNTIME MENU TRUTH.
// Generated from the complete 427-item Lazy Jane's menu model.
// Used only by the one-time empty-database menu seed/import path.
// After seeding, PostgreSQL is canonical and manager edits must never be
// regenerated or overwritten from this file.
//
// Historical normalized source shape:
