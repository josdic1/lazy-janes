...
describe("order contract", () => {
  ...
  it("requires each preparation selection to target exactly one component", () => {
    const ingredientId = "47f58dcf-d8a4-466a-a534-f62e182e936b";
    const choiceOptionId = "57f58dcf-d8a4-466a-a534-f62e182e936b";
    const preparationOptionId = "67f58dcf-d8a4-466a-a534-f62e182e936b";
        ...
        items: [
          {
            menuItemId,
            preparationSelections: [
              { ingredientId, choiceOptionId, preparationOptionId },
            ],
          },
        ],
      }).success,
